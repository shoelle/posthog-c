 ...
 * in-flight request is superseded. Sender-thread/callback calls enqueue but do
 * not wait. The SDK also refreshes during ph_init (preload_flags) and after
 * identity/group changes. On wasm this asks posthog-js to reload. */
